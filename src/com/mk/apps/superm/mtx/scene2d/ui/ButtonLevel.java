package com.mk.apps.superm.mtx.scene2d.ui;
...
import com.mk.apps.superm.mtx.scene2d.ui.AbstractButton;
...
public class ButtonLevel extends AbstractButton {
	...
	public ButtonLevel(Drawable up, Drawable down,BitmapFont font) {
		super(font, up, down);
	}
	...
	private void drawLevelNumber(Batch batch) {
		...
		float doublePositionArranger = 3.8f;
