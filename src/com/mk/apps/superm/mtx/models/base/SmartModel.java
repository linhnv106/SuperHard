...
package com.mk.apps.superm.mtx.models.base;

import java.util.Random;

import com.badlogic.gdx.scenes.scene2d.actions.Actions;
import com.mk.apps.superm.mtx.AbstractActor;
import com.mk.apps.superm.mtx.effects.EffectCreator;

public class SmartModel extends AbstractActor {
	private Random rnd;
	...
	public SmartModel(float posX, float posY, float width, float height, Random rnd) {
	...
	public SmartModel(float width, float height, Random rnd, boolean DIPActive) {
	...
	private void makeNewMoveToDirectionDecision() {
		...
		if (isTopDown) {
			...
			actionMoveTo(bottomX, bottomY, rndSpeed);
		} else {
			setPosition(bottomX, bottomY);
			actionMoveTo(topX, topY, rndSpeed);
		}
	...
	private void reset() {
		...
		//
		durationSpeedMoveFreely = 10;
		durationSpeedFadeInOut = 1;
	}
