...
package com.mk.apps.superm.mtx;
...
public class AbstractWorldScene2d extends Group  {
	...
	public AbstractWorldScene2d(float posX, float posY, float worldWidth, float worldHeight) {
		super();
		setSize(worldWidth, worldHeight);
		setPosition(posX, posY);
		//
		MtxLogger.log(logActive, true, logTag, "World Set: W: " + worldWidth +  " - " + "H: " + worldHeight);
	}
	...
	public void setBackgroundTexture(TextureRegion textureBackground, Scaling scaling, boolean fillParent, boolean touchable) {
	...
	/**
	 * Render the world for MVC style development, otherwise use act & draw of stage.
	 * */
	public void render(){
